...
import { IFeaturedIcon, IKeyword, IKeywordPaginateParams } from '@/types';
import { useToast } from '@/hooks/use-toast';
import axiosClient from '@/lib/axiosClient';
import { LOCATIONS_MAP } from '@/consts/locations';
    ...
    <div className="mx-1 py-3">
      <Card className="bg-opacity-5 bg-gray-200">
        ...
        <CardContent>
          ...
          {fetchLoading ? (
            <p className={'p-1.5'}>Loading keywords . . .</p>
