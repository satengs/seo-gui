        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link href="/keywords">
                <Button variant="outline">View Keywords</Button>
              </Link>
            </div>
          </div>
        </div>
            ...
            <TabsContent value="trends" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Track your visibility across different SERP features over
                    time
                  </CardDescription>
                </CardHeader>
            ...
            <TabsContent value="entities" className="space-y-4">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Monitor entities associated with your brand in the Knowledge
                    Graph
                  </CardDescription>
                </CardHeader>
                <CardContent>
